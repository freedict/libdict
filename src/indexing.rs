...
fn get_base(input: char) -> Result<i64, ()> {
    match input {
...
pub fn get_offset(word: &str) -> Result<i64, DictError> {
    let mut index = 0i64;
...
fn parse_line(line: &str, line_number: usize) -> Result<(String, i64, i64), DictError> {
...
pub fn parse_index<B: BufRead>(br: B) -> Result<HashMap<String, (i64, i64)>, DictError> {
...
pub fn parse_index_from_file(filename: String) -> Result<HashMap<String, (i64, i64)>, DictError> {
